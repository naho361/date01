...
$site_top = "http://razz7le.noor.jp/";

// 管理者メールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "akahane.naho@gmail.com";
...
$thanksPage = "http://razz7le.noor.jp/thx.html";
...
<p align="center" class="formbutton"><input type="hidden" name="mail_set" value="confirm_submit">
